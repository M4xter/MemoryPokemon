...
LANG=['aspicot', 'bulbizarre', 'draco', 'mimitoss', 'nosferapti',
      'pikachu', 'psykokwak', 'rondoudou', 'ronflex', 'salameche']
...
lbl=Label(fen, text=0, font=("Bauhaus 93 bold", 20))
